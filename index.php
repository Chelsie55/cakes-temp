...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 1719;
        $headers['auth']['clientCompany'] = "E7vGAVFiF6M2pP71rTnh";
        $headers['auth']['clientSecret'] = "MTcxOUU3dkdBVkZpRjZNMnBQNzFyVG5oY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
